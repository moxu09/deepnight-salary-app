...
export default function AdminStaffPage() {
  ...
  async function loadStaff() {
    ...
    if (serviceError) {
      ...
      alert("讀取員工可接遊戲失敗，請確認 players_services 資料表已建立");
    }
    ...
    <main className="deepnight-page">
      ...
      <header className="relative z-10 border-b border-pink-200/50 bg-white/45 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 md:flex-row md:items-center md:justify-between">
          ...
          <button
            onClick={loadStaff}
            className="deepnight-soft-button flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold"
          >
            <RefreshCw size={16} />
            重新整理
          </button>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 py-8">
        ...
        {loading ? (
          <div className="deepnight-card mt-6 rounded-[32px] p-8 text-center text-[#8b5a8f]">
            載入中...
          </div>
        ) : staffList.length === 0 ? (
          <div className="deepnight-card mt-6 rounded-[32px] p-8 text-center text-[#8b5a8f]">
                ...
                >
                  <div className="flex flex-col gap-4 border-b border-pink-100 pb-5 md:flex-row md:items-center md:justify-between">
                    ...
                    <button
                      ...
                      className="deepnight-button flex items-center justify-center gap-2 px-5 py-3 font-bold"
                    >
                      <Save size={18} />
